export default function FancyCtaLink({ href, children }) {
  return (
    <a
      href={href}
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-primary/20 via-primary/10 to-primary/20 animate-pulse rounded-lg" />
