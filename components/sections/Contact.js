...
export default function Contact() {
    return (
        <div className="section" id="contact">
            ...
            <div className='grid grid-cols-5 md:gap-12 lg:gap-12 mt-12'>
                <div className="col-span-12 md:col-span-3">
                    <Form />
                </div>
                <div className="flex flex-col gap-8 col-span-12 md:col-span-2 justify-center mt-10 md:mt-0">
                    <img loading="lazy" src="/trusted/g2.png" alt="Logo G2 Esports" width={130} height={130} className="-ms-7 invert brightness-0 " />
                    ...
                    <div className="flex items-center gap-4">
                        <div>
                            <img loading="lazy" src="/trusted/p.webp" alt="Pierre G2 Esports" className="rounded-full" width={45} height={45} />
                        </div>
                        <div>
