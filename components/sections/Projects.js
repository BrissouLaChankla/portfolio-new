...
const projects = [
  ...
  { slug: "legends-fusion", link: "legends-fusion.com", name: "Legends Fusion", description: "Jeu web permettant de construire un personnage de League of Legends en combinant les compétences de personnages choisis aléatoirement.", tools: ["NextJS", "DaisyUI"] },
  ...
  { slug: "quizbrain", link: "#", name: "QuizBrain", description: "Exercices avec Next14 et webservice pour mes élèves. Le but étant de travailler avec les pages dynamiques et le SSR", tools: ["NextJS", "Tailwind CSS", "DaisyUI"] },
