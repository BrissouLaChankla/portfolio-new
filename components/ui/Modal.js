        ...
        <>
          <div className="modal-box w-11/12 max-w-5xl p-0">
            <div className="flex flex-col sm:flex-row">
              <form method="dialog">
                <button className="btn btn-sm btn-circle absolute right-2 btn-outline sm:btn-ghost border-2 sm:border-0 top-2 z-20">
                  ✕
                </button>
              </form>
              <div className="relative w-full sm:w-3/12 bg-primary">
                <Image
                  src={`/projects/${data.slug}.svg`}
                  alt={data.slug}
                  height={500}
                  width={300}
              ...
              <div className="flex flex-col gap-8 my-8 sm:w-9/12 px-10 justify-between">
                ...
                <div className="flex flex-col sm:flex-row-reverse gap-4 justify-between items-center">
                  {data.link === "#" ? (
                    <i className=" self-stretch sm:self-end text-primary">
                      {messages("Projects.private")}...
                    </i>
                  ) : (
                    <a
